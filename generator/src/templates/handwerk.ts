...
export function renderHandwerkPage(spec: SiteSpec, slug: string): string {
  const PRESET = getBranchPreset('handwerk');
...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    /* ─── CTA ────────────────────────────────────────────── */
    .cta-section {
      background-image: linear-gradient(rgba(28,25,23,0.85), rgba(28,25,23,0.92)), url('${projectPhoto(spec, slug, 90, 1800, 1200)}');
      background-size: cover; background-position: center;
...
<section id="projekte" class="section ba-section">
  <div class="container">
    ...
    <div class="ba-grid">
      <div class="ba-pair reveal" style="background-image: url('${projectPhoto(spec, slug, 11)}');">
        <span class="ba-tag">Wohnung Salzburg</span>
      </div>
      <div class="ba-pair reveal" style="background-image: url('${projectPhoto(spec, slug, 12)}');">
        <span class="ba-tag">Geschäft Linz</span>
      </div>
      <div class="ba-pair reveal" style="background-image: url('${projectPhoto(spec, slug, 13)}');">
        <span class="ba-tag">Sanierung Mondsee</span>
      </div>
      <div class="ba-pair reveal" style="background-image: url('${projectPhoto(spec, slug, 14)}');">
        <span class="ba-tag">Vollwärmeschutz</span>
      </div>
      <div class="ba-pair reveal" style="background-image: url('${projectPhoto(spec, slug, 15)}');">
        <span class="ba-tag">Bodenverlegung</span>
      </div>
      <div class="ba-pair reveal" style="background-image: url('${projectPhoto(spec, slug, 16)}');">
